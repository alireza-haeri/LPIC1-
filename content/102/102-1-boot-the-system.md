...
- ارسال 1 یا S: بوت در حالت تک‌کاربره (recovery)
- اجبار گرافیک به حالت 1024×768×24: ارسال vga=792
...
مشاهده تمام لاگ‌ها از جمله بعد از بوت:
...
مدیر سیستم می‌تواند با init سرویس‌ها را متوقف و راه‌اندازی کند.
...
- جایگزین جدید
- توسط purист‌های لینوکس به دلیل عدم پیروی از اصول یونیکس دوست داشته نمی‌شود
...
فرآیند init همیشه شناسه 1 دارد:
...
توضیح: گروه‌های سرویس‌ها از طریق فایل‌های واحد target راه‌اندازی می‌شوند.
...
در بسیاری موارد می‌توانید به این صورت استفاده کنید:
